...
Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,973 | 🐛 106 | 📅 2026-09-02 list. Feel free to improve this list by contributing!
...
* [@editorjs/paragraph](https://github.com/editor-js/paragraph) ⭐ 60 | 🐛 30 | 🌐 TypeScript | 📅 2024-12-16 — text block base tool
...
* [title-editorjs](https://github.com/EmersonMatias/title-editorjs) ⭐ 12 | 🐛 1 | 🌐 TypeScript | 📅 2023-11-18 - Provides Title (headings) Blocks for the Editor.js with various settings like H1...H6, colors (red, pink, purple...) and text-align. It is compatible with react and typescript, without causing typing errors.
...
* [@skchawala/editorjs-text-style](https://github.com/skchawala/editorjs-text-style) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-13 - inline tool for customizing font size and font family — lightweight, configurable, and easy to use.
...
* [@calumk/editorjs-columns](https://github.com/calumk/editorjs-columns) ⭐ 141 | 🐛 11 | 🌐 JavaScript | 📅 2026-04-02 — Multi-Column Layout tool, using nested editorJs Instances
* [editorjs-layout](https://github.com/hata6502/editorjs-layout) ⭐ 81 | 🐛 5 | 🌐 TypeScript | 📅 2023-06-01 — Layout block tool for Editor.js.
* [editorjs-collapsible-block](https://github.com/sebmeister2077/editorjs-accordion) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-06 — Accordion-like block tool that manages collapsing of the next blocks.
...
* [editorjs-antd-renderer](https://github.com/gosvoh/editorjs-antd-renderer) ⭐ 3 | 🐛 1 | 🌐 TypeScript | 📅 2026-05-19 — Render Editor.js data to React [Ant Design](https://github.com/ant-design/ant-design) ⭐ 99,479 | 🐛 1,082 | 🌐 TypeScript | 📅 2026-09-11 components
...
* [editorjs-php](https://github.com/editor-js/editorjs-php) ⭐ 263 | 🐛 14 | 🌐 PHP | 📅 2024-04-17 — server-side data validation, HTML sanitization and convertation output JSON to the Block objects
...
* [Editor.js - Directus Extension](https://github.com/dimitrov-adrian/directus-extension-editorjs-interface) ⭐ 186 | 🐛 12 | 🌐 CSS | 📅 2023-04-17 - Add an Editor.js interface to [Directus](https://github.com/directus/directus) ⭐ 37,861 | 🐛 403 | 🌐 TypeScript | 📅 2026-09-11
